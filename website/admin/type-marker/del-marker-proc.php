        ...
        <tr>
          <td class="side_box" valign="top">
            <table cellspacing="0" cellpadding="0" border="0">
              <tbody>
                <tr>
                  <td><b><?php echo clean_for_display ($admin_del_marker_process); ?></b></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="font-weight: bold;">
                    <?php
                      // try to delete the marker.
                      delete_marker ($mid);
                    ?>
                    <p><?php echo clean_for_display ($navigate_goto_text); ?>&nbsp;[ <a href="<?php echo FILE_MAN_MARKER_LIST; ?>"><?php echo clean_for_display ($navigate_list_text); ?></a> ]</p>
                  </td>
                </tr>
              </tbody>
            </table>
