        ...
        <tr>
          <td class="side_box" valign="top">
            <table cellspacing="0" cellpadding="0" border="0">
              <tbody>
                <tr>
                  <td><b><?php echo clean_for_display ($admin_add_marker_process); ?></b></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="font-weight: bold;">
                    <?php
                      // try to add the new marker.
                      add_new_marker ($_POST);
                    ?>
                    <p><?php echo clean_for_display ($navigate_goto_text); ?>&nbsp;[ <a href="javascript: history.go(-1);"><?php echo clean_for_display ($navigate_back_text); ?></a> ]</p>
                  </td>
                </tr>
              </tbody>
            </table>
