  ...
  <body>
    <table cellpadding="30" cellspacing="0" border="0" class="hundred">
      <tbody>
        <tr valign="top">
          <td class="side_box">
            <b>- <a href="<?php echo FILE_ADD_TYPE_FORM; ?>"><?php echo clean_for_display ($admin_op_add_type_text); ?></a></b>
            <br>
            <b>- <a href="<?php echo FILE_ADD_MARKER_FORM; ?>"><?php echo clean_for_display ($admin_op_add_marker_text); ?></a></b>
          </td>
        </tr>
      </tbody>
    </table>
