                            ...
                            <td>
                              <table cellpadding="0" cellspacing="0" border="0">
                                <tbody>
                                  ...
                                  <tr>
                                    <td><?php echo clean_for_display ($admin_upd_type_form_symbol); ?></td>
                                    <td><?php echo input_text ('type_symbol', 'width: 230px;', clean_for_display ($tdata['letter']), 'maxlength="1"'); ?></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td align="right">
                                      <?php
                                        ...
                                        echo space (10, 1);
                                        echo '<a href="'.FILE_UPD_TYPE_FORM.'?tid='.$tid.'"><img src="../../'.DIR_GRAPHICS."/clear.png".'" border="0" alt=""></a>';
                                      ?>
                                    </td>
                                  </tr>
                                </tbody>
